...
export default function Inicio({ rutas, message }) {
    ...
    let rutasLista = rutas.map(function (ruta) {
        return (
            <div
                key={ruta.id}
                className="overflow-hidden bg-white shadow-sm sm:rounded-lg mb-8"
            >
                <div className="p-6 text-gray-900">
                    ...
                    <div className="flex flex-row gap-4 w-full">
                        <img
                            src="/avatar.svg"
                            alt="Driver Avatar"
                            className="w-fit h-12 rounded-full cursor-pointer"
                        />
                        ...
                        <div className="">
                            ...
                            <div>{convertDate(ruta.feha_publicado)}</div>
                        </div>
                    ...
                    <div className="grid grid-flow-col">
                        <div>
                            <div className="text-xl">{ruta.descripcion}</div>
    ...
    return (
        ...
        >
            ...
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                {!rutasLista.length ? (
                    <div
                        class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 relative rounded mx-auto w-[90%]"
                        role="alert"
                    >
                        <strong class="font-bold block text-xl">
                            No encontrado
                        </strong>
                        <span class="block sm:inline">
                            La búsqueda que ingresaste no fue encontrada :(
                        </span>
                    </div>
                ) : (
                    rutasLista
